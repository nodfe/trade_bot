      ...
      return (
        ...
        >
          ...
          <div
            ...
            data-mobile="true"
            className={cn(
              "fixed inset-y-0 z-50 h-full w-[--sidebar-width-mobile] bg-sidebar p-0 text-sidebar-foreground transition-transform duration-200 ease-in-out",
              side === "left"
                ? openMobile
                  ? "translate-x-0"
                  : "-translate-x-full"
...
>(({ className, ...props }, ref) => {
  ...
  return (
    <button
      ...
      className={cn(
        "absolute inset-y-0 z-20 hidden w-4 -translate-x-1/2 transition-all ease-linear group-data-[side=left]:-right-4 group-data-[side=right]:left-0 after:absolute after:inset-y-0 after:left-1/2 after:w-[2px] hover:after:bg-sidebar-border group-data-[collapsible=offcanvas]:translate-x-0 group-data-[collapsible=offcanvas]:after:left-full group-data-[side=right]:after:-translate-x-1/2 sm:flex",
...
>(
  ({ asChild = false, isActive = false, variant = "default", size = "default", tooltip, className, ...props }, ref) => {
    if (asChild) {
      const { children, ...anchorProps } = props as React.ComponentProps<"a"> & {
